...
// Shave off trailing zeros and decimal point, if possible.
     ...
     * @return A JSONObject which is the value.
     */
    public org.json.JSONObject optJSONObject(String key) { return this.optJSONObject(key, null); }
    ...
    public org.json.JSONObject optJSONObject(String key, org.json.JSONObject defaultValue) {
        Object object = this.opt(key);
        return object instanceof org.json.JSONObject ? (org.json.JSONObject) object : defaultValue;
    }
    ...
    public org.json.JSONObject put(String key, Map<?, ?> value) throws JSONException {
        return this.put(key, new org.json.JSONObject(value));
    }
     ...
     *
     * <p>If <pre>{@code indentFactor > 0}</pre> and the {@link org.json.JSONObject}
